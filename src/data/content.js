...
export const prices = [
  ['Signature Cut & Finish', '$95+'],
  ['Dimensional Colour', '$220+'],
  ['Glass Skin Ritual', '$145'],
  ['Luxury Manicure', '$70'],
  ['Bridal Atelier', '$390+'],
]

export const reviews = [
  ['The detail is unreal. My colour looks expensive without looking overdone.', 'Amelia R.', 'Colour Client'],
  ['I came in tired and left looking — and feeling — like myself again.', 'Sofia K.', 'Skin Ritual'],
  ['The most considered salon experience I’ve had. Every touch feels intentional.', 'Maya L.', 'Hair & Wellness'],
  ['My bridal look photographed beautifully and still felt completely like me.', 'Leila N.', 'Bridal Atelier'],
  ['Warm, precise, beautifully paced. Nothing felt rushed.', 'Nora A.', 'Signature Cut'],
  ['The space feels like a private ritual, not an appointment slot.', 'Elena V.', 'Wellness'],
]
